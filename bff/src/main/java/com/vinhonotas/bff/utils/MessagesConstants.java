...
public class MessagesConstants {
    ...
    public static final String ERROR_WHEN_UPDATING = "Erro ao atualizar registro, verifique os campos informados";
    ...
    public static final String ERROR_WHEN_LOGIN = "Usuário ou senha inválido, verifique.";
